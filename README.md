...
### The goal of this project is not just deployment, but to build a production-like DevOps ecosystem independently that showcases a strong understanding of real-world DevOps practices, including containerization, Kubernetes orchestration, Infrastructure as Code (IaC), CI/CD pipelines, scalability, monitoring, and automation.
...
Run and manage the multi-container application locally using Docker Compose.
